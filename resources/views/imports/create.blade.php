            ...
            <form action="{{ route('imports.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                @if(Auth::user()->rol == 'admin')
                    <div class="form-group">
                        <label for="provider_id">{{ __('common.proveedor') }}</label>
                        <select name="provider_id" id="provider_id" class="@error('provider_id') is-invalid @enderror">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="commercial_invoice_number" id="commercial_invoice_number"
                        class="@error('commercial_invoice_number') is-invalid @enderror"
                        value="{{ old('commercial_invoice_number') }}" placeholder="{{ __('common.comercial_invoice') }}" />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="proforma_invoice_number" id="proforma_invoice_number"
                        class="@error('proforma_invoice_number') is-invalid @enderror"
                        value="{{ old('proforma_invoice_number') }}"
                        placeholder="{{ __('common.numero_proforma_invoice') }}" />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bl_number" id="bl_number" class="@error('bl_number') is-invalid @enderror"
                        value="{{ old('bl_number') }}" placeholder="{{ __('common.numero_bill_of_lading') }}" />
                    @error('bl_number') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="form-group">
                    <label for="origin">{{ __('common.origen') }}</label>
                    <input type="text" name="origin" id="origin" class="@error('origin') is-invalid @enderror"
                        value="{{ old('origin') }}" placeholder="{{ __('common.origen') }}" />
                    @error('origin') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="form-group">
                    <label for="destination">{{ __('common.destino') }}</label>
                    <input type="text" name="destination" id="destination" value="{{ __('common.colombia') }}" disabled
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="departure_date" id="departure_date"
                        class="@error('departure_date') is-invalid @enderror" value="{{ old('departure_date') }}" />
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="arrival_date" id="arrival_date"
                        class="@error('arrival_date') is-invalid @enderror" value="{{ old('arrival_date') }}" />
                ...
                <div class="form-group">
                        ...
                        <div class="container-item"
                            ...
                            <div
                                ...
                                <button type="button" class="btn-remove-container"
                                    style="background: #dc3545; color: white; border: none; padding: 4px 10px; border-radius: 4px; cursor: pointer; font-size: 12px; display: none;">{{ __('common.eliminar') }}</button>
                            </div>
                            <div class="form-group" style="margin-bottom: 12px;">
                                <label style="font-size: 13px; margin-bottom: 4px;">{{ __('common.referencia') }}</label>
                                <input type="text" name="containers[0][reference]" id="container_ref_0" class="form-control"
                                    style="padding: 8px 12px; font-size: 14px;" />
                            </div>
                            <div class="form-group" style="margin-bottom: 12px;">
                                <label
                                    style="font-size: 13px; margin-bottom: 4px;">{{ __('common.pdf_informacion_contenedor') }}</label>
                                <div class="file-input-wrapper">
                                    <input type="file" name="containers[0][pdf]" id="container_pdf_0" class="file-input"
                                        style="padding: 6px; font-size: 13px;" accept="application/pdf" />
                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                <label
                                    style="font-size: 13px; margin-bottom: 4px;">{{ __('common.pdf_imagenes_contenedor') }}</label>
                                <div class="file-input-wrapper">
                                    <input type="file" name="containers[0][image_pdf]" id="container_image_pdf_0"
                                        class="file-input" style="padding: 6px; font-size: 13px;"
                    ...
                    <button type="button" id="add-container-btn"
                        style="background: #28a745; color: white; border: none; padding: 8px 16px; border-radius: 6px; cursor: pointer; font-size: 14px; font-weight: 500; margin-top: 10px;">
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-wrapper">
                        <input type="file" name="proforma_pdf" id="proforma_pdf"
                            class="file-input @error('proforma_pdf') is-invalid @enderror" accept="application/pdf" />
                        <div class="file-input-custom">
                            <span class="file-button">{{ __('common.seleccionar_archivo') }}</span>
                            <span class="file-name">{{ __('common.ningun_archivo_seleccionado') }}</span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-wrapper">
                        <input type="file" name="proforma_invoice_low_pdf" id="proforma_invoice_low_pdf"
                            class="file-input @error('proforma_invoice_low_pdf') is-invalid @enderror"
                            accept="application/pdf" />
                        <div class="file-input-custom">
                            <span class="file-button">{{ __('common.seleccionar_archivo') }}</span>
                            <span class="file-name">{{ __('common.ningun_archivo_seleccionado') }}</span>
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-wrapper">
                        <input type="file" name="invoice_pdf" id="invoice_pdf"
                            class="file-input @error('invoice_pdf') is-invalid @enderror" accept="application/pdf" />
                        <div class="file-input-custom">
                            <span class="file-button">{{ __('common.seleccionar_archivo') }}</span>
                            <span class="file-name">{{ __('common.ningun_archivo_seleccionado') }}</span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-wrapper">
                        <input type="file" name="commercial_invoice_low_pdf" id="commercial_invoice_low_pdf"
                            class="file-input @error('commercial_invoice_low_pdf') is-invalid @enderror"
                            accept="application/pdf" />
                        <div class="file-input-custom">
                            <span class="file-button">{{ __('common.seleccionar_archivo') }}</span>
                            <span class="file-name">{{ __('common.ningun_archivo_seleccionado') }}</span>
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-wrapper">
                        <input type="file" name="packing_list_pdf" id="packing_list_pdf"
                            class="file-input @error('packing_list_pdf') is-invalid @enderror" accept="application/pdf" />
                        <div class="file-input-custom">
                            <span class="file-button">{{ __('common.seleccionar_archivo') }}</span>
                            <span class="file-name">{{ __('common.ningun_archivo_seleccionado') }}</span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-wrapper">
                        <input type="file" name="bl_pdf" id="bl_pdf"
                            class="file-input @error('bl_pdf') is-invalid @enderror" accept="application/pdf" />
                        <div class="file-input-custom">
                            <span class="file-button">{{ __('common.seleccionar_archivo') }}</span>
                            <span class="file-name">{{ __('common.ningun_archivo_seleccionado') }}</span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-wrapper">
                        <input type="file" name="apostillamiento_pdf" id="apostillamiento_pdf"
                            class="file-input @error('apostillamiento_pdf') is-invalid @enderror"
                            accept="application/pdf" />
                        <div class="file-input-custom">
                            <span class="file-button">{{ __('common.seleccionar_archivo') }}</span>
                            <span class="file-name">{{ __('common.ningun_archivo_seleccionado') }}</span>
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-wrapper">
                        <input type="file" name="other_documents_pdf" id="other_documents_pdf"
                            class="file-input @error('other_documents_pdf') is-invalid @enderror"
                            accept="application/pdf" />
                        <div class="file-input-custom">
                            <span class="file-button">{{ __('common.seleccionar_archivo') }}</span>
                            <span class="file-name">{{ __('common.ningun_archivo_seleccionado') }}</span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="shipping_company" id="shipping_company"
                        class="@error('shipping_company') is-invalid @enderror" value="{{ old('shipping_company') }}" />
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="free_days_at_dest" id="free_days_at_dest"
                        class="@error('free_days_at_dest') is-invalid @enderror" min="0"
                        value="{{ old('free_days_at_dest') }}" />
                ...
                <div class="form-group">
                    ...
                    <select name="credit_time" id="credit_time" class="@error('credit_time') is-invalid @enderror">
                        <option value="" {{ old('credit_time') == '' || old('credit_time') == null ? 'selected' : '' }}>
                            {{ __('common.sin_credito') }}</option>
                        <option value="15" {{ old('credit_time') == '15' ? 'selected' : '' }}>15 {{ __('common.dias') }}
                        </option>
                        <option value="30" {{ old('credit_time') == '30' ? 'selected' : '' }}>30 {{ __('common.dias') }}
                        </option>
                        <option value="45" {{ old('credit_time') == '45' ? 'selected' : '' }}>45 {{ __('common.dias') }}
                        </option>
                    </select>
