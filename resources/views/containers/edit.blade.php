            ...
            productItem.innerHTML = `
                ...
                <div class="product-fields">
                    ...
                    <div>
                        ...
                        <input type="number" name="products[${productIndex}][boxes]" min="0" value="${selectedBoxes}" required oninput="calculateSheets(${productIndex}); calculateWeight(${productIndex});">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="products[${productIndex}][weight_per_box]" min="0" value="${selectedWeight}" required oninput="calculateWeight(${productIndex})">
                    </div>
                    <div>
