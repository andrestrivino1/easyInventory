    ...
    @csrf @method('PUT')
        ...
        <div class="form-group">
            ...
            <select id="rol" name="rol" required>
                ...
                <option value="cliente_funcionario" {{ old('rol', $usuario->rol)=='cliente_funcionario' ? 'selected':'' }}>Cliente Funcionario (Clientes + Contenedores)</option>
                ...
                <option value="placas" {{ old('rol', $usuario->rol)=='placas' ? 'selected':'' }}>Placas (Liquidación de Viajes)</option>
        ...
        <div class="form-group" id="conductores-group" style="display:none;">
            ...
            <div class="checkbox-group">
                @forelse ($drivers as $driver)
                    <div class="checkbox-item">
                        <input type="checkbox" id="driver_{{ $driver->id }}" name="drivers[]" value="{{ $driver->id }}" {{ (old('drivers') && in_array($driver->id, old('drivers'))) || (!$errors->any() && in_array($driver->id, $assignedDriverIds)) ? 'checked' : '' }}>
